...
happyReduction_8 (HappyTerminal happy_var_2)
	(HappyAbsSyn22  happy_var_1)
	 =  HappyAbsSyn8
		 (Pos (getPos happy_var_1) $ ((unIdent happy_var_2), happy_var_1)
	)
...
unIdent :: PosToken -> PosString
unIdent (Pos p (TIdent str)) = Pos p str

unInt :: PosToken -> PosInt
unInt (Pos p (TIntLiteral i)) = Pos p i

unDouble :: PosToken -> PosDouble
unDouble (Pos p (TDoubleLiteral d)) = Pos p d

unString :: PosToken -> PosString
unString (Pos p (TStringLiteral s)) = Pos p s

getPos :: PosToken -> (Int, Int)
getPos (Pos p _) = p
